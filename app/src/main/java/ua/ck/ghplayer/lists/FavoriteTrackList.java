...
public class FavoriteTrackList {
    ...
    private static ArrayList<Track> saveFavoriteTrackList;
    ...
    public void saveFavoriteTrackList() {
        saveFavoriteTrackList = new ArrayList<>();
        saveFavoriteTrackList.addAll(favoriteTrackList);
    }

    public ArrayList<Track> getSaveFavoriteTrackList() {
        return saveFavoriteTrackList != null ? saveFavoriteTrackList : null;
    }
