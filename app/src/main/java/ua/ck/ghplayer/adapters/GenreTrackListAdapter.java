...
public class GenreTrackListAdapter extends RecyclerSwipeAdapter<GenreTrackListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.swipeLayout.getSurfaceView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                eventBus.post(new OnClickAdapterEvent(Constants.GENRE_TRACK_LIST_ID, position));
            }
        });
        ...
        holder.buttonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PlaylistUtils.addTrackToFavorite(context, GenreTrackList.getInstance().getGenreTrackList().get(position).getId());
                mItemManger.closeAllItems();
            }
        });
